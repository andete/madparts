...
def test_eagle_export_polygon():
  with open('examples/Polygon.coffee') as f:
    hl_coffee = f.read()
...
def test_kicad_export_empty():
  coffee = empty_coffee
  _export_kicad_package(coffee, 'TEST_EMPTY', kicad_empty)

def test_kicad_import_empty():
  _import_kicad_package(kicad_empty, "TEST_EMPTY", empty_coffee)

kicad_polygon = """(module
Polygon
(layer F.Cu)
(descr "a simple polygon example")
(fp_poly (pts (xy 0 -1) (xy -1 0) (xy 0 1) (xy 1 0) (xy 0 -1)) (layer Dwgs.User) (width 0.1))
(fp_arc (start 0.0 0.0) (end 1.41421356237 -1.41421356237) (angle -180.0) (layer F.SilkS) (width 0.2))
(fp_poly (pts (xy 1 0) (xy 3 -2) (xy 4 0) (xy 3 2) (xy 1 0)) (layer Dwgs.User) (width 0.05))
(fp_poly (pts (xy 1 4) (xy -1 4) (xy -1 3) (xy 0.0 2) (xy 1 4)) (layer F.SilkS) (width 0.1))
(fp_poly (pts (xy 1.1 -1.2) (xy 1.1 -0.2) (xy 0.1 -1.2) (xy 1.1 -1.2)) (layer F.SilkS) (width 0.05))
(fp_arc (start 0.566987298108 2.61602540378) (end 2.0 1.0) (angle -30.0) (layer F.SilkS) (width 0.075)))"""
